...
static const char *const yytname[] =
{
  ...
  "NO_TOKEN", "T_INT", "T_REAL", "T_STRING", "';'", "$accept", "top_input",
  "top_stmt", "exit", "test", YY_NULLPTR
};
#endif
